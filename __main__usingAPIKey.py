...
def main():
    ...
    summary = getSummaries(created_at, repo, branches)
    # TODO: Convert branches to list
    seconds = grandTotalSeconds(summary, branches)
    hours = math.ceil(seconds/3600)
    print('Hours for ', repo, branches, ': ', hours)

def grandTotalSeconds(summary_dict, branch):
...
def getSummaries(createdAt, project, branches):
    creds = Credentials
    ...
    path_with_params = add_url_params(path, params)
